...
Book.find_by_name('Lachrimae')
    .songs.create(name: 'Lachrimae Antiquae Novae', song_no:2, parts_no: 5, pdf_path: "data:application/pdf;base64,#{Base64.encode64(File.read('test.pdf'))}")
Book.find_by_name('First Book of Songs')
    .songs.create(name: 'Unquiet Thoughts', song_no: 1, parts_no: 4)
