...
Book.find_by_name('Pavans Galliards Almains')
    .songs.create(name: 'Pavan', song_no: 3, parts_no: 5, has_text: false, is_transcribed: true, pdf_path: '/pdf/pga/3')
Book.find_by_name('Lachrimae')
    .songs.create(name: 'Lachrimae Antiquae', song_no: 1, parts_no: 5, has_text: false, is_transcribed: false, pdf_path: '/pdf/lach/1')
Book.find_by_name('Lachrimae')
    .songs.create(name: 'Lachrimae Antiquae Novae', song_no:2, parts_no: 5, has_text: false, is_transcribed: false, pdf_path: '/pdf/lach/2')
Book.find_by_name('First Book of Songs')
    .songs.create(name: 'Unquiet Thoughts', song_no: 1, parts_no: 4, has_text: true, is_transcribed: false, pdf_path: '/pdf/1stbs/1')
