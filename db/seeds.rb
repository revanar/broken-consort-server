...
Book.find_by_name('Pavans Galliards Almains')
    .songs.create(name: 'Tears of the Muses', song_no: 2, parts_no: 5, has_text: false)
Book.find_by_name('Pavans Galliards Almains')
    .songs.create(name: 'Pavan', song_no: 3, parts_no: 5, has_text: false)
Book.find_by_name('Lachrimae')
    .songs.create(name: 'Lachrimae Antiquae', song_no: 1, parts_no: 5, has_text: false)
Book.find_by_name('Lachrimae')
    .songs.create(name: 'Lachrimae Antiquae Novae', song_no:2, parts_no: 5, has_text: false)
